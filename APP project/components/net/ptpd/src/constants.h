...
#define USER_DESCRIPTION \
  "SyncCore"
#define USER_DESCRIPTION_MAX 32
...
#define DEFAULT_INBOUND_LATENCY      	0//210 //290*2//250       /* in nsec */
...
#define DEFAULT_UTC_OFFSET           	35
#define DEFAULT_UTC_VALID            	FALSE
#define DEFAULT_PDELAYREQ_INTERVAL   	1      /* -4 in 802.1AS */

#define DEFAULT_DELAYREQ_INTERVAL    	1      /* new value from page 237 of the standard */
...
#define DEFAULT_PRIORITY2		248        /* page 238, default priority is the midpoint, to allow easy control of the BMC algorithm */
...
/**
 * \brief PTP states (Table 8 in the spec)
 */
enum {
/*

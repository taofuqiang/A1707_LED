...
void aliyun_iot_common_log_init(void);
void aliyun_iot_common_log_release(void);
void aliyun_iot_common_set_log_level(IOT_LOG_LEVEL_E iotLogLevel);
IOT_LOG_LEVEL_E aliyun_iot_common_get_log_level(void);

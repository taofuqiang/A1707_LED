...
#ifndef _DRV_F1_ETH_H
#define _DRV_F1_ETH_H
...
/** @defgroup ENET_Buffers_setting
  * @{
  */
#define ETH_MAX_PACKET_SIZE    1520   /*!< ETH_HEADER + ETH_EXTRA  + ETH_MAX_ETH_PAYLOAD + ETH_CRC */
...
/* 网络phy定义                                                                                    */
/**************************************************************************************************/
#define MII_MODE                0       /* 1: MII MODE, 0: RMII MODE. */

#if MII_MODE //DP83848
#define PHY_Addr        0x01
#define PHY_LINK_SR     0x10
#define PHY_SR          0x10     /*!< Tranceiver Status Register */
#define PHY_LINK_INTERRUPT  ((u16)0x2000)  /*!< PHY link status interrupt mask*/
#define PHY_LINK_STATUS     ((u16)0x0001)  /*!< PHY Link mask*/
...
#define PHY_LINK_SR     0x01
#define PHY_SR          0x1F     /*!< Tranceiver Status Register */
#define PHY_LINK_INTERRUPT  ((u16)0x10)  /*!< PHY link status interrupt mask*/
#define PHY_LINK_STATUS     ((u16)0x0004)  /*!< PHY Link mask*/
